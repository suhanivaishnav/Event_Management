	...
	public function getProducts() {
		...
		if(isset($products) && count($products)) {			
            foreach ($products as $key => $product) {				
                $productHTML .= '<article class="col-md-4">';
                $productHTML .= '<div class="thumbnail product">';
                $productHTML .= '<figure>';
                $productHTML .= '<b><a href="#"><img src="images/'.$product['image'].'" alt="'.$product['product_name'].'" /><a></b>';	
                $productHTML .= '</figure>';
                $productHTML .= '<div class="caption">';
                $productHTML .= '<h4><a href="" class="product-name">'.$product['product_name'].'</a></h4>';
                $productHTML .= '<div class="price"><h5><b>Rent: '.$product['price'].' ₹</b></h5></div>';
                $productHTML .= '<h6><b>Cuisines : </b>'.$product['brand'].'</h6>';
                $productHTML .= '<h6><b>Capacity : </b>'.$product['material'].'</h6>';
                $productHTML .= '<h6><b>Rating : </b>'.$product['size'].'
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="'.$product['C_Link'].'"><i class="fa fa-eye">View More</i></a></h6>';
				//link for view more
                $productHTML .= '</div>';
                $productHTML .= '</div>';
                $productHTML .= '</article>';				
