  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        ...
        <a class="nav-link" href="packages.php"><i class="fa fa-plus"></i>Create event</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      </nav>
    </header>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              ...
              <a href="decorator.php">view more <i class="fa fa-angle-right"></i></a>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="product-item">
              <a href="package-details.php"><?php
              echo '<img src="data:image/jpeg;base64,'.base64_encode($d_img).'" height=200/>';
              ?></a>
              <div class="down-content">
                <a href="package-details.php"><h4><?php echo $d_name;?></h4></a>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              ...
              <a href="photographer.php">view more <i class="fa fa-angle-right"></i></a>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="product-item">
              ...
              ?></a>
              <div class="down-content">
                <a href="package-details.html"><h4><?php echo $p_name;?></h4></a>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              ...
              <a href="caterer.php">view more <i class="fa fa-angle-right"></i></a>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="product-item">
              ...
              ?></a>
              <div class="down-content">
                <a href="package-details.html"><h4><?php echo $c_name;?></h4></a>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              <h2>Featured DJs</h2>
              <a href="dj.php">view more <i class="fa fa-angle-right"></i></a>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="product-item">
              ...
              ?></a>
              <div class="down-content">
                <a href="package-details.html"><h4><?php echo $dj_name;?></h4></a>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              ...
              <a href="ideas.php">view more <i class="fa fa-angle-right"></i></a>
            </div>
          </div>
