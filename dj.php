...
<html lang="en">
  ...
  <body>
            ...
            <ul class="navbar-nav ml-auto">
              <li class="nav-item"><a class="nav-link" href="packages.php">Destination</a></li>
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="packages.html" type="button" aria-haspopup="true" aria-expanded="false">Vendors
                  </a>
    ...
    <!-- Page Content -->
    <div class="page-heading about-heading header-text" style="background-image: url(assets/images/djbg.jpg);">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
          ...
          <div class="col-md-4">
            <div class="product-item">
              ...
              <div class="down-content">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="<?php echo $dj_link;?>"><i class="fa fa-eye">View More</i></a>
