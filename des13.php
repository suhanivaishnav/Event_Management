    ...
    <div class="products" style="background: #C5C7CC ; margin-top: 50px;">
      <div class="container">
        ...
        <?php
          ...
          $sql="select * from Destination where Des_ID=13"; 
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <br>
              ...
              <br>
  <a href="https://www.google.com/maps/place/Paraizo+the+Club/@21.276678,72.7185719,17z/data=!3m1!4b1!4m6!3m5!1s0x3be04b2620ac0387:0xdc94fd4e26951f59!8m2!3d21.276678!4d72.7211468!16s%2Fg%2F11bvtfdjtw">
