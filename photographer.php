...
<html lang="en">
  ...
  <body>
    ...
    <!-- Page Content -->
    <div class="page-heading about-heading header-text" style="background-image: url(assets/images/photobg.jpg);">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="product-item">
              ...
              echo '<img src="data:image/jpeg;base64,'.base64_encode($p_img).'" height=300 width=650/>';
              ?></a>
              <div class="down-content">
                ...
                <p>Available for <b><?php echo $p_days;?></b> Days
                <br>
                Rating:<?php echo $p_rating;?></p>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="<?php echo $p_link;?>"><i class="fa fa-eye">View More</i></a>
