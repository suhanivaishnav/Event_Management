    ...
    <div class="products" style="background: #C5C7CC ;  margin-top: 50px;">
      <div class="container">
        ...
        <?php
          ...
          $sql="select * from Destination where Des_ID=12"; 
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <br>
              ...
              <br>
              <a href="https://www.google.com/maps/place/Riya+Party+Plot/@21.1575891,72.7887047,17z/data=!3m1!4b1!4m6!3m5!1s0x3be04df08df3ebe3:0x2177db9526519c95!8m2!3d21.1575891!4d72.7912796!16s%2Fg%2F1hm2k6b60">
