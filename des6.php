...
<html lang="en">
  ...
  <body style="background: #C5C7CC;">
    ...
    <div class="products" style="background: #C5C7CC ;">
      <div class="container">
        <div class="row">
        <?php
          $con = mysqli_connect("localhost","root");
          mysqli_select_db($con,"L.M.E.");
          $sql="select * from Destination where Des_ID=6"; 
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <br>
              ...
              <br>
  <a href="https://www.google.com/maps/place/Hotel+Privya+Surat+-+Rooms+%26+Banquet/@21.1862682,72.7763637,17z/data=!3m1!4b1!4m9!3m8!1s0x3be04dc4c35e0e5b:0xc19f9ccf7ec00a86!5m2!4m1!1i2!8m2!3d21.1862682!4d72.7789386!16s%2Fg%2F11h7d7_h3b">
