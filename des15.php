    ...
    <div class="products" style="background: #C5C7CC ;">
      <div class="container">
        ...
        <?php
          ...
          $sql="select * from Destination where Des_ID=15"; 
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <br>
              ...
              <br>
  <a href="https://www.google.com/maps/place/Dil+Se+Re+Restaurant/@21.1862206,72.7905088,17z/data=!4m6!3m5!1s0x3be04dd03b9cdf25:0x46676a59cc34780!8m2!3d21.1862206!4d72.7930837!16s%2Fg%2F1tdlsr6_">
