...
<html lang="en">
  ...
  <body style="background: #A6ACAF ;">
    ...
    <!-- Page Content -->
        ...
        <div class="container" style="background: #A6ACAF ;">
          <div class="row">
            <div class="col-md-12">
            </div>
          </div>
    ...
    <div class="products" style="background: #A6ACAF ; margin-top: 50px;">
      <div class="container">
        <div class="row">
        <?php
        ...
        <div class="row">
          <div class="col-md-6">
            <div>
              <br>
            <?php
              echo '<img src="data:image/jpeg;base64,'.base64_encode($p_img).'"  class="img-fluid wc-image"/>';
              ?>            
              </div>
            <br>
            <div class="row">
          ...
          <br>
              <p class="lead">
                   <i class="fa fa-inr"></i> <?php echo $p_bud;?>&nbsp;&nbsp;
              </p>

              <p>Available for <b><?php echo $p_days;?></b> Days</p>

               <p><?php echo $p_ser;?></p>

              <br>
  <i class="fa fa-map-marker"></i>  <strong><?php echo $p_loc;?></strong>
              <br><br> 
              <h6>Google Rating: <?php echo $p_rating;?></h6>
              <br> 
              <h6>Contact No: <?php echo $p_contact;?></h6>   
              <br> 
              <h6>E-mail: <?php echo $p_email;?></h6>   
              <br>      
              <div class="col-md-4">
              <button  style="background-color: #17202A ; width: 150px; height: 40px;" >
              <a href="wishlist5.php?p_id=<?php echo $p_id ?>&p_name=<?php echo $p_name?>&p_budget=<?php echo $p_bud?>&p_link=<?php echo $p_link?>">
